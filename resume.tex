...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Baishakhi}{Ray}%{\Large{Baishakhi Ray}}
\address{500 West 120 Street, Room 450, MC0401, New York City, New York, USA-10027}
\mobile{(+1) 303-748-2958} 
%%% Social
\email{rayb@cs.columbia.edu}
\homepage{http://rayb.info}
%\github{posquit0}
%\linkedin{posquit0}
%%% Optionals
\position{Assistant Professor{\enskip\cdotp\enskip}Columbia University}
